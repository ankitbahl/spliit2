...
const csv_file = 'ankit-b-and-ankita_2024-01-03_export.csv'
...
function generate(results) {
  const out = [];
  const ankitId = 'Z9XxotqLDaf4xrcgMRkYq';
  const ankitaId = 'eqSRBAwDgFatYs8hmMuCZ';
  const groupId = '923lqdgZzRA9rtHvpwUkM';
